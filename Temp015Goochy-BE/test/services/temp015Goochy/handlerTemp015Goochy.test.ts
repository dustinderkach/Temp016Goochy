...
import { handler } from "../../../src/services/temp015Goochy/handlerTemp015Goochy";
...
describe("Temp015Goochy handler test suite", () => {
	test("Returns temp015Goochy from dynamoDb", async () => {
